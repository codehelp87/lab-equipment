...
<h4 style="padding: 20px;">Edit | <?php echo e($equipment->title); ?> </h4>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="time_unit" name="time_unit" placeholder="Unit Time" required="required" value="<?php echo e($equipment->time_unit); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="reservation_time" class="col-sm-2 control-label">Max Reservation Time</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="reservation_time" name="reservation_time" placeholder="Max Reservation Time" required="required" value="<?php echo e($equipment->max_reservation_time); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="price_per_unit" class="col-sm-2 control-label">Price per unit Time</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="price_per_unit" name="price_per_unit" placeholder="Price per unit Time" required="required" value="<?php echo e($equipment->price_per_unit_time); ?>">
        </div>
    </div>
    <div class="form-group">
